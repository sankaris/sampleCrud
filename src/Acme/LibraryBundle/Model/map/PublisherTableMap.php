...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.LibraryBundle.Model.map.PublisherTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Acme\\LibraryBundle\\Model\\Publisher');
    ...
    {
        $this->addRelation('Book', 'Acme\\LibraryBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), null, null, 'Books');
    } // buildRelations()
