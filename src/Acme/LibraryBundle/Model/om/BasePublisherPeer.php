...
use \PropelException;
use \PropelPDO;
use Acme\LibraryBundle\Model\Publisher;
use Acme\LibraryBundle\Model\PublisherPeer;
use Acme\LibraryBundle\Model\map\PublisherTableMap;
...
abstract class BasePublisherPeer
{
    ...
    const OM_CLASS = 'Acme\\LibraryBundle\\Model\\Publisher';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\LibraryBundle\\Model\\map\\PublisherTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Publisher objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublisherPeer::ID, PublisherPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublisherPeer::ID => 0, PublisherPeer::NAME => 1, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePublisherPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\LibraryBundle\Model\map\PublisherTableMap());
      }
    }
